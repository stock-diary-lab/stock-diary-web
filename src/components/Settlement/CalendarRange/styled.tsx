...
export const CalendarDate = styled.div<{
  ...
  ${(props) =>
    props.isPrev && `background: #6ca4f4; border-top-right-radius: 0; border-bottom-right-radius: 0; color: white}`}
  ${(props) =>
    props.isNext && `background: #6ca4f4; border-top-left-radius: 0; border-bottom-left-radius: 0; color: white}`}

  ${(props) => props.isBetween && `background: ${props.theme.colors.whiteGray}; border: none; border-radius: 0;`}
`;
